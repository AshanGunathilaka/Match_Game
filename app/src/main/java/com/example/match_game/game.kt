...
class game : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val Button_numbers1 = arrayOf('A', 'B', 'C', 'D', 'E')
        val Button_numbers2 = arrayOf('A', 'B', 'C', 'D', 'E')
        val Button_numbers3 = arrayOf('A', 'B', 'C', 'D', 'E')
        val Button_numbers4 = arrayOf('A', 'B', 'C', 'D', 'E')
        val Button_numbers5= arrayOf('A', 'B', 'C', 'D', 'E')
